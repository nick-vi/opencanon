...
export { defaultRuntimeNamespace, defaultServiceRegistryPath, privateProjectRuntimeStatePath, projectProcessStateDirectory, projectRuntimeStatePath, projectRuntimeStatePathInRoot, runtimeNamespaceForRegistry, RuntimeNamespaceEnv, StableRuntimeNamespace, validateRuntimeNamespace } from "./service-namespace.ts";
