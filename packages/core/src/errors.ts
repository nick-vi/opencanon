...
export const openCanonErrorCodeValues = [
  ...
  "inference-duplicate-operation",
  "inference-host-unavailable",
  "inference-invalid-request",
  "inference-model-mismatch",
  "inference-queue-full",
  "inference-request-too-large",
  "inference-coordinator-stopped",
  "inference-token-budget-exceeded",
