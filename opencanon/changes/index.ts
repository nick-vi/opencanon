  ...
  defineChange({
    ...
    tasks: [
      ...
      },
      {
        ...
        files: ["packages/core/src/change.ts", "packages/core/src/index.ts", "packages/runtime/src/change-check-runner.ts", "packages/runtime/src/cli.ts", "packages/runtime/src/local-protocol.ts", "packages/runtime/src/server.ts", "packages/runtime/src/server-change-runtime.ts", "packages/runtime/src/server-http.ts", "packages/runtime/test/change-runs.test.ts", "packages/runtime/test/client-test-sources.ts", "packages/runtime/test/client.test.ts", "packages/runtime/test/service.test.ts", "opencanon/specs/index.ts", "opencanon/changes/index.ts", "docs/opencanon/specs/project-runtime-lifecycle-spec.md", "docs/opencanon/specs/runtime-operations-spec.md"],
