...
export default [
  ...
  defineChange({
    ...
    tasks: [
      ...
      { id: "bounded-index-pipeline", title: "Bound source, fact, chunk, and embedding batches", files: ["packages/runtime/src/knowledge-index-manager.ts", "packages/runtime/src/project-source-snapshot.ts", "packages/runtime/src/semantic-index.ts", "packages/runtime/test/semantic-index.test.ts"], checks: ["semantic-index-tests", "typecheck"], dependsOn: ["explicit-read-contract"] },
      { id: "isolated-index-operation", title: "Run indexing outside the serving runtime", files: ["packages/runtime/src/server.ts", "packages/runtime/src/server-routes.ts", "packages/runtime/src/cli.ts", "packages/runtime/test/client.test.ts"], checks: ["runtime-client-tests", "service-tests", "process-steady-state"], dependsOn: ["bounded-index-pipeline"] },
