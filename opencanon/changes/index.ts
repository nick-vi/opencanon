  ...
  defineChange({
    ...
    tasks: [
      ...
      },
      {
        ...
        files: ["packages/cli/src/validate.ts", "packages/cli/src/changes.ts", "packages/runtime/src/change-check-runner.ts", "tests/validator-producers.test.ts", "packages/runtime/test/change-runs.test.ts"],
