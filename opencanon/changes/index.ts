...
export default [
  ...
  defineChange({
    ...
    tasks: [
      ...
      { id: "isolated-index-operation", title: "Run indexing outside the serving runtime", files: ["packages/core/src/errors.ts", "packages/runtime/src/server.ts", "packages/runtime/src/server-routes.ts", "packages/runtime/src/routes.ts", "packages/runtime/src/snapshot.ts", "packages/runtime/src/cli.ts", "packages/runtime/src/local-protocol.ts", "packages/runtime/src/knowledge-index-operation.ts", "packages/runtime/src/knowledge-index-worker.ts", "packages/runtime/src/knowledge-index-worker-main.ts", "packages/runtime/test/client.test.ts", "packages/runtime/test/client-test-sources.ts", "tests/runtime-events.test.ts", "scripts/build-opencanon-runtime.ts"], checks: ["runtime-client-tests", "service-tests", "process-steady-state"], dependsOn: ["bounded-index-pipeline"] },
