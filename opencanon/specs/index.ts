  ...
  defineSpec({
    ...
    rules: [
      ...
      },
      {
        ...
        acceptance: ["failed publication keeps the previous graph and revision", "runtime restart resumes above the last published revision", "live delivery relays the committed replay event without appending it again", "unchanged refreshes advance revision without rewriting the product projection"],
